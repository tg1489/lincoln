  ...
  return isMobile ? (
    ...
    <>
      ...
      <div className='col mb-5 mt-5 ideas-table'>
        ...
        purchases to our organization. All you have to do is link our school to
        your Amazon account! Click the Amazon link here to sign up!
        {/* Button */}
        <Row className='mt-3'>
          <div className='col'>
      ...
      <div className='col mb-5 mt-5 ideas-table'>
        ...
        Lincoln Elementary School PTO. Then, each time you shop at Stop & Shop
        using your Stop & Shop rewards card, you will earn cash for our school!
        {/* Button */}
        <Row className='mt-3'>
          <div className='col'>
        ...
        Fundraising made easy! Download the free Shoparoo app, select our school
        from the list and start taking pictures of your everyday purchase
        receipts!
        {/* Button */}
        <Row className='mt-3'>
          <div className='col'>
      ...
      <div className='col mb-5 mt-5 ideas-table'>
        ...
        Earn even more cash to help your school get what it needs through the
        Box Tops for Education® Bonus App. Turn your everyday receipts into cash
        for your school.
        {/* Button */}
        <Row className='mt-3'>
          <div className='col'>
